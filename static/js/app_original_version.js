...
//function to build a table using data from data.js with the "data" parameter created above
function buildTable(data) {
  ...
  //function to filter the data into a new table at the click of a button
